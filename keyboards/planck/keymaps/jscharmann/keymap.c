...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LY_0010] = {
        ...
        {___X___, MY_DCLK, KC_MS_L, KC_MS_D, KC_MS_R, MY_TCLK, MY_ZZ,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, ___X___},
     ...
     *
     * ╔═════╦═════╦═════╦═════╦═════╦═════╦═════╦═════╦═════╦═════╦═════╦═════╗
     * ║xxxxx║ T0  ║ T1  ║ T2  ║ T3  ║xxxxx║xxxxx║ T8  ║ T9  ║ T10 ║ T11 ║Reset║
     * ╠═════╬═════╬═════╬═════╬═════╬═════╬═════╬═════╬═════╬═════╬═════╬═════╣
     * ║xxxxx║ T4  ║ T5  ║ T6  ║ T7  ║xxxxx║xxxxx║ T12 ║ T13 ║ T14 ║ T15 ║xxxxx║
     * ╠═════╬═════╬═════╬═════╬═════╬═════╬═════╬═════╬═════╬═════╬═════╬═════╣
     ...
     */
    [LY_1111] = {
        {___X___,TG(LY_0000),TG(LY_0001),TG(LY_0010),TG(LY_0011),___X___,___X___,TG(LY_1000),TG(LY_1001),TG(LY_1010),TG(LY_1011),RESET  },
        {___X___,TG(LY_0100),TG(LY_0101),TG(LY_0110),TG(LY_0111),___X___,___X___,TG(LY_1100),TG(LY_1101),TG(LY_1110),TG(LY_1111),___X___},
        {___X___,___X___,    ___X___,    ___X___,    ___X___,    ___X___,___X___,___X___,    ___X___,    ___X___,    ___X___,    ___X___},
        {___X___,___X___,    ___X___,    _______,    _______,    ___X___,___X___,_______,    _______,    ___X___,    ___X___,    ___X___}
    },
};
